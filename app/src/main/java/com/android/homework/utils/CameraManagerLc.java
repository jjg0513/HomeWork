...
public class CameraManagerLc {
    private static CameraManagerLc mInstance;
    ...
    public static CameraManagerLc getInstance() {
        if (mInstance == null) {
            mInstance = new CameraManagerLc();
        }
        return mInstance;
    }

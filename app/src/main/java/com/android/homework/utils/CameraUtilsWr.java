...
public class CameraUtilsWr {
    private static CameraUtilsWr mInstance;
    ...
    public static CameraUtilsWr getInstance() {
        if (mInstance == null) {
            mInstance = new CameraUtilsWr();
        }
        return mInstance;
    }
    ...
    public CameraUtilsWr.CameraInfo getCameraInfo() {
        if(mCamera != null) {
            Camera.Size size = mCamera.getParameters().getPreviewSize();
            CameraInfo cameraInfo = new CameraUtilsWr.CameraInfo();
